...
export default function Login() {
  ...
  const subtitleStyle1 = {
    ...
    fontWeight: 600,
    lineHeight: '26px',
    marginTop: '94px' // Adjusted margin between UserName and subtitle
  };
  const descriptionStyle = {
    ...
    marginTop: '0px', // Adjusted margin from subtitle
    textAlign: 'center'
  };
  ...
  return (
    <div style={formContainerStyle}>
     <div style={rectangleStyle}></div>
      ...
      <div style={descriptionStyle}>We Will Send You the <span style={digitStyle}>4 Digit</span> Verification Code</div>
